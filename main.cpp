...
void TriangleWindow::render()
{
    ...
    for (int i = 0; i < totalCoordinates/8; i += 3) {
        colors[i] = 1.0f;
        colors[i + 1] = 0.0f;
        colors[i + 2] = 0.0f;
    }

    for (int i = totalCoordinates/ 8; i < totalCoordinates/4; i += 3) {
        colors[i] = 0.0f;
        colors[i + 1] = 0.0f;
        colors[i + 2] = 1.0f;
    }
    ...
    for (int i = totalCoordinates / 4; i < totalCoordinates/2; i += 3) {
        colors[i] = 1.0f;
        colors[i + 1] = 0.0f;
        colors[i + 2] = 1.0f;
    }
    ...
    for (int i = totalCoordinates / 2; i < totalCoordinates; i += 3) {
        colors[i] = 1.0f;
        colors[i + 1] = 0.0f;
        colors[i + 2] = 1.0f;
    }
